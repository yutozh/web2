<template>
  <div class="date-picker">
    <div class="input-wrapper" @mouseenter="showCancel = true" @mouseleave="showCancel = false">
      ...
      <!--<img class="cancel-btn" src="../../assets/img/datePicker-cancel.png" v-show="showCancel" @click="clear">-->
      <!--</transition>-->
    </div>
    <transition name="toggle">
      <div class="date-panel" v-show="panelState" :style="coordinates">
        ...
        <div class="type-month" v-show="panelType === 'month'">
          <ul class="month-list">
            <li v-for="(item, index) in monthList" v-bind:key="index"
        ...
        <div class="type-date" v-show="panelType === 'date'">
          <ul class="weeks">
            <li v-for="item in weekList" v-bind:key="item">{{item | week(language)}}</li>
          </ul>
          <ul class="date-list">
            <li v-for="(item, index) in dateList" v-bind:key="index"
